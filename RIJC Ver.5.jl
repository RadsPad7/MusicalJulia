...
function songlibrary(letter2)
    ...
    elseif letter2 == "D"
        println(" E E F G G F E D C C D E D C C
                Ga Ga Ma Pa Pa Ma Ga Ri Sa Sa Ri Ga Ri Sa Sa")
    end
end
...
println("Enter the name which you want to save the converted file as..")
#readline
FILE_Nam = readline()
...
close(f)
    ...
    elseif userchoice == "B"
        ...
        if user_input_b == "Yes" || user_input_a == "Y" || user_input_a == "yes"
            while true
